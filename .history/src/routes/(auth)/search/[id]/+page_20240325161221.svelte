<script lang="ts">
	...
	const emailBody = `Hello, my name is ${person.acf.firstname} ${person.acf.lastname} and I would like to update the following information on my community mirrors profile: %0A%0A`;
</script>
...
<a
	...
	class="btn btn-primary mt-4">Update Profile</a
>
